...
describe('AboutMe component', () => {
  ...
  it('renders the contents', () => {
    ...
    expect(screen.queryByTestId('desc').textContent).toBe(
      "I'm Dominic Arrojado and my passion is turning design into code. I'm a web developer specializing in both front-end & back-end development. I'm experienced in developing small to large web applications. I'm currently based in Singapore and working at PropertyGuru as a Lead Engineer (FinTech)."
    );
  });
